...
const file_groupcache_proto_rawDesc = "" +
	...
	"\n" +
	"GetRequest\x12\x14\n" +
	"\x05group\x18\x01 \x02(\tR\x05group\x12\x10\n" +
	"\x03key\x18\x02 \x02(\tR\x03key\"Z\n" +
	"\vGetResponse\x12\x14\n" +
	"\x05value\x18\x01 \x01(\fR\x05value\x12\x1d\n" +
	"\n" +
	"minute_qps\x18\x02 \x01(\x01R\tminuteQps\x12\x16\n" +
	"\x06expire\x18\x03 \x01(\x03R\x06expire2J\n" +
	"\n" +
	"GroupCache\x12<\n" +
	"\x03Get\x12\x18.groupcachepb.GetRequest\x1a\x19.groupcachepb.GetResponse\"\x00B&Z$accedo.io/groupcache/v2/groupcachepb"
